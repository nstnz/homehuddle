...
// Copied: androidx.compose.foundation
/**
 ...
 */
@Composable
internal fun Modifier.dashedBorder(border: BorderStroke, shape: Shape = RectangleShape, on: Dp, off: Dp) =
...
@Composable
internal fun Modifier.dashedBorder(width: Dp, brush: Brush, shape: Shape, on: Dp, off: Dp): Modifier =
	composed(
		factory = {
			this.then(
